...
- **The Testing Component Question**: If an exam scenario asks you how a developer can validate that a newly deployed ASG scaling policy works correctly without waiting for real production users to hit the site, look for answers that mention installing toolsets like **stress** or **look busy** via SSM Terminal or User Data to artificially choke the instance's OS threads.
